...
export function setPixel(x, y, char) {
    x = Math.round(x);
    y = Math.round(y);
...
export function project3D(x, y, z, camZ = 5) {
...
export function drawLine(x0, y0, x1, y1, char = '.') {
...
export function drawLine3D(x0, y0, z0, x1, y1, z1, char = '#') {
